#@MedThon - الريس_حــ۫͜ـســﻭۦٰٰٰٰ⊱ @L_U_2 
...
DEFAULTUSERBIO = DEFAULT_BIO or "الحمد الله على كل شئ - @MedThon"
CHANGE_TIME = Config.CHANGE_TIME
DEFAULTUSER = AUTONAME or Config.ALIVE_NAME
MedT = Config.CUSTOM_ALIVE_EMMed or " "
...
•  **الشـرح •• **__لوضـع بروفايـل وقتـي يتغيـر تلقائيـاً مع حسابـك كل دقيقـه لشرح الامر اذهب الى https://t.me/Med_Thon/63 __
  **╮•❐ الامـر ⦂ **`.البايو تلقائي`
•  **الشـرح •• **__لوضـع بايـو وقتـي يتغيـر تلقائـياً مع الوقـت كـل دقيقـه لشرح الامر اذهب الى https://t.me/Med_Thon/63 __
