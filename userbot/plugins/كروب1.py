# for -<*>~ SOURCE Med ~<*>- edit By: @MedTHON
...
async def _(event):
    if event.fwd_from:
        return
    mentions = "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝗠𝗘𝗗𝗧𝗵𝗼𝗻 𝑮𝑹𝑶𝑼𝑷 𝑫𝑨𝑻𝑨 𓆪\n** ⪼ المشرفـون في ۿذه المجموعه :** \n"
    reply_message = None
...
async def Med(Medthon):
    mentions = Medthon.text[8:]
    chat = await Medthon.get_input_chat()
    async for x in Medthon.client.iter_participants(chat, 100):
        mentions += f"\n**-** @{x.username} "
    await Medthon.client.send_message(Medthon.chat_id, mentions)
    await Medthon.delete()
@bot.on(admin_cmd(pattern="معرفات 200(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="معرفات 200(?: |$)(.*)", allow_sudo=True))
async def Med(Medthon):
    mentions = Medthon.text[8:]
    chat = await Medthon.get_input_chat()
    async for x in Medthon.client.iter_participants(chat, 200):
        mentions += f"\n**-** @{x.username} "
    await Medthon.client.send_message(Medthon.chat_id, mentions)
    await Medthon.delete()
...
async def Med(Medthon):
    mentions = Medthon.text[8:]
    chat = await Medthon.get_input_chat()
    async for x in Medthon.client.iter_participants(chat, 300):
        mentions += f"\n**-** @{x.username} "
    await Medthon.client.send_message(Medthon.chat_id, mentions)
    await Medthon.delete()
...
async def Med(Medthon):
    mentions = Medthon.text[8:]
    chat = await Medthon.get_input_chat()
    async for x in Medthon.client.iter_participants(chat, 500):
...
async def Med(Medthon):
    mentions = Medthon.text[8:]
    chat = await Medthon.get_input_chat()
    async for x in Medthon.client.iter_participants(chat, 1000):
        mentions += f"- @{x.username} "
    await Medthon.client.send_message(Medthon.chat_id, mentions)
    await Medthon.delete()
...
async def Med(Medthon):
    mentions = Medthon.text[8:]
    chat = await Medthon.get_input_chat()
    async for x in Medthon.client.iter_participants(chat, 150):
        mentions += f"\n**𒀭╎**  [{x.first_name}](tg://user?id={x.id}) "
    await Medthon.client.send_message(Medthon.chat_id, mentions)
    await Medthon.delete()
...
async def Med(Medthon):
    mentions = Medthon.text[8:]
    chat = await Medthon.get_input_chat()
    async for x in Medthon.client.iter_participants(chat, 50):
        mentions += f"\n**𒀭╎**  [{x.first_name}](tg://user?id={x.id}) "
    await Medthon.client.send_message(Medthon.chat_id, mentions)
    await Medthon.delete()
...
async def Med(Medthon):
    mentions = Medthon.text[8:]
    chat = await Medthon.get_input_chat()
    async for x in Medthon.client.iter_participants(chat, 10):
        mentions += f"\n**𒀭╎**  [{x.first_name}](tg://user?id={x.id}) \n"
    await Medthon.client.send_message(Medthon.chat_id, mentions)
    await Medthon.delete()
...
async def get_users(show):
    if show.fwd_from:
        return
    mentions = "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝗠𝗘𝗗𝗧𝗵𝗼𝗻 𝑮𝑹𝑶𝑼𝑷 𝙏𝘼𝙂 𓆪\n**⪼ هييه تعالـو يحبابين**  𓎤: \n"
    reply_to_id = None
...
async def _(event):
    ...
    async for i in bot.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𝑺𝑼𝑹𝑪𝑬 𝗠𝗘𝗗𝗧𝗵𝗼𝗻  - 𝑮𝑹𝑼𝑶𝑷 𝑺𝑻𝑨𝑻𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
async def fetch_info(chat, event):
    ...
    caption = "<b> 𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 𝗠𝗘𝗗𝗧𝗵𝗼𝗻  - 𝑮𝑹𝑼𝑶𝑷 𝑫𝑨𝑻𝑨 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    ...
    if hasattr(chat_obj_info, "scam") and chat_obj_info.scam:
        ...
        caption = f"<b>𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝘿𝙀𝙑 - @L_U_2  𓆪</b>"
    return caption
