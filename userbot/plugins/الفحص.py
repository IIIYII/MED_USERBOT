...
@Medthon.on(admin_cmd(outgoing=True, pattern="فحص$"))
@Medthon.on(sudo_cmd(pattern="فحص$", allow_sudo=True))
async def zelzalalive(event):
    ...
    ALIVE_TEXT = Config.CUSTOM_ALIVE_TEXT or "** بـوت  مدثــون 𝐑𝐀𝐈𝐈𝐒𝙏𝙃𝙊𝙉  يعمـل .. بنجـاح ☑️ 𓆩 **"
    ZZL_IMG = Config.ALIVE_PIC or "https://telegra.ph/file/57d51af1ca93d8cc8a958.jpg"
    Med_caption = Config.Med_MEDIA or Medmp
    caption = Med_caption.format(
...
**{Z_EMOJI} إصـدار مدثــون :** `{zdver}`
**{Z_EMOJI} إصـدار البـايثون :** `{pyver}`
**{Z_EMOJI} الوقـت :** `{uptime}`
**{Z_EMOJI} المسـتخدم:** {mention}
**{Z_EMOJI} قنـاة السـورس :** [اضغـط هنـا](https://t.me/MedThon)"""
