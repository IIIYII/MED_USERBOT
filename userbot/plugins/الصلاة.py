...
@Medthon.on(admin_cmd(pattern="صلاة(?: |$)(.*)"))
async def get_adzan(adzan):
    L_U_2 = adzan.pattern_match.group(1)
    if L_U_2 == "صنعاء" or L_U_2 == "اليمن":
	    url = f"https://api.pray.zone/v2/times/today.json?city=Sanaa"
	    request = requests.get(url)
	    if request.status_code != 200:
	        await edit_delete(
	            adzan,
	            f"** لم يـتم العثور على هـذه المدينه {L_U_2}**\n**-يرجى كتابة اسم العاصمـه او الدولـة بشكـل صحيـح** ",
	            5,
	        )
	        return
	    result = json.loads(request.text)
	    Medthonresult = f"<b>🕋╎اوقـات الصـلاة بالتـوقيت المحلـي لعواصـم الـدول <b>\
		        ...
		        \n\nᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗘𝗗𝗧𝗛𝗢𝗡╎@MedThon\
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "مصر" or L_U_2 == "القاهرة" or L_U_2 == "القاهره":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "بغداد" or L_U_2 == "العراق":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "دمشق" or L_U_2 == "سوريا":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "الدوحه" or L_U_2 == "قطر":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "مسقط" or L_U_2 == "سلطنه عمان":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "مكه" or L_U_2 == "السعوديه":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "بيروت" or L_U_2 == "لبنان":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "عمان" or L_U_2 == "الاردن":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "الرباط" or L_U_2 == "المغرب":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "الخرطوم" or L_U_2 == "السودان":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "بنغازي" or L_U_2 == "ليبيا":
	    ...
	    "
	    await edit_or_reply(adzan, Medthonresult, "html")
    elif L_U_2 == "ازمير" or L_U_2 == "اسطنبول" or L_U_2 == "انقره" or L_U_2 == "تركيا":
