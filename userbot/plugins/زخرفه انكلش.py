...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await catevent.edit("**╮•⎚ تحـقق من انـك لم تقـم بحظر البوت @@Med1_bot .. ثم اعـد استخدام الامـر ...🤖♥️**")
            return
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await catevent.edit(
                "**╮•⎚ تحـقق من انـك لم تقـم بحظر البوت @@Med1_bot .. ثم اعـد استخدام الامـر ...🤖♥️**"
            )
            return
...
CMD_HELP.update(
    {
      ...
      \n**الشـرح ••** زغـارف انكـلش تمبلـر مامطروقـه ولأول مـره ع تليـثون أمر يزغرف عدة زغـارف انكـلش بوقت واحد .. الملف حقوق مدثــون#.. . "
    }
)
