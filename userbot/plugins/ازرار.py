#    Copyright (C) 2020  Medthon
# button post makker for MedThon thanks to uniborg for the base
...
CMD_HELP.update(
    ...
    \n•  **Example :** `.كول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/L_U_2 > [مد ثـون]<buttonurl:https://t.me/MedThon> [اوامر السورس]<buttonurl:https://t.me/Med_Thon>`\
    \n\n•  **Syntax : **`.كوول`\
    \n•  **Function :** __Buttons must be in the format as [Name on button]<buttonurl:link you want to open>__\
    \n•  **Example :** `.كوول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/L_U_2 > [مد ثـون]<buttonurl:https://t.me/MedThon> [اوامر السورس]<buttonurl:https://t.me/Med_Thon>`\
    "
    }
)
