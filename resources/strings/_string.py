...
DEFAULTUSER = str(Name) if Name else "Med THON"
...
Start = (
    """
    <------------------------------------>
         يتم تحميل ملفات السورس مد ثـون
    <------------------------------------>
    """
)
...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗘𝗗𝗧𝗵𝗼𝗻 - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**𝗠𝗘𝗗𝗧𝗵𝗼𝗻**─━─━─━─━◐\n"
    "**⌔╎قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**𝗠𝗘𝗗𝗧𝗵𝗼𝗻**─━─━─━─━◐\n"
    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗘𝗗𝗧𝗵𝗼𝗻 - [𝘿𝙀𝙑](t.me/Medthon) 𓆪"
)
...
StartLoaded = "<ⵧⵧⵧⵧⵧⵧ⫷ - Med PLUGINS - ⫸ⵧⵧⵧⵧⵧⵧ>"
ASSISTANT = "<ⵧⵧⵧⵧⵧⵧ⫷ - Med ASSISTANT - ⫸ⵧⵧⵧⵧⵧⵧ>"
KIMOTOSHA = "<ⵧⵧⵧⵧⵧⵧⵧⵧ⫷ - Med TOSHA - ⫸ⵧⵧⵧⵧⵧⵧⵧ>"
ANIMATIONS = "<ⵧⵧⵧⵧⵧⵧ⫷ - Med ANIMATIONS - ⫸ⵧⵧⵧⵧⵧ>"
ADMIN = "<ⵧⵧⵧⵧⵧ⫷ - Med ADMIN TOOLS - ⫸ⵧⵧⵧⵧⵧ>"
ASSISTANTPM = "<ⵧⵧⵧⵧⵧ⫷ - Med ASSISTANT PM - ⫸ⵧⵧⵧⵧⵧ>"
...
⫷ بوت مد ثـون يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
   ⫷ ارجع الى حسابك ودز الامر (.الاوامر) ⫸
⫷ @MedThon - اذا كنت بحاجه الى مساعده فتوجه الى ⫸
⫷ @L_U_2  - تحياتي : الريـــس حــ۫͜ـســﻭ ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين مد ثـون ⫸',
    '⫷ اكتمل تنزيل انلاين مد ثـون بدون اخطاء ⫸',
    '⫷ يتم بدء بوت مد ثـون ⫸',
    '⫷ اكتمل بدء بوت مد ثـون ⫸'
]
